...
include $_SERVER['DOCUMENT_ROOT'] . '/src/api/obter.php';
                ...
                <?php foreach ($lista as $item) { ?>
                    <div class="item-list-row flex-container-row items-center wrap py-xxs">
                        ...
                        <div class="px-m py-xxs text-right">
                            <a href="<?php echo '/ver/?numeroCertificado='.$item->numero?>" target="_blank" class="button"><i class="zmdi zmdi-eye"></i> Ver Certificado</a>
                        </div>
                    </div>
                <?php } ?>
