<head>
    <title><?php echo $titleStart; ?> Certificado Emitido <?php echo $titleEnd; ?></title>
</head>
<body>
    <div id="content" components="" class="block">
        ...
        <div class="container very-small">
            ...
            <div class="card content-wrap auto-height">
                ...
                <div class="text-center"><img class="w-50" src="<?php echo $pathUrl;?>/assets/img/undraw_graduation_re_gthn.svg" alt="Ilustração" /></div>
